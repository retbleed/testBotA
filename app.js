...
const flowPrincipal = addKeyword(['hola', 'ole', 'alo']).addAnswer('Hola! Bienvenido yo soy xBot').addAnswer('¿Que puedo hacer hoy por ti?', {buttons: [{body: '🤩 Quiero una promo'},{body: '🍔 Ver menu burgers'},{body: '🍳 Ver menu brunch'},{body: '😎 Reserva'},{body: '📍 Ubicacion'}]}, null, null, [flowBurgers, flowBrunch, flowReserva, flowUbi])
